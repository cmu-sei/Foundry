...
@Component({
    ...
    template: `
        <button mat-raised-button color="primary" class="btn-sm" *ngIf="!deleteMsgVisible && !asLink" (click)="confirm()">
        ...
        <p *ngIf="deleteMsgVisible" class="callout callout-danger">
            {{ prompt }}
            <button (click)="delete()" mat-raised-button color="primary" class="btn-sm" >
