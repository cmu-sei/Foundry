...
export class AuthService {
    ...
    // post(url, data, opts = {}) {
    //     this.addAuth(opts);
    //     return this.http.post(url, data, opts).pipe(map(this.mapData));
    // }

    postClean(url, data, opts = {}) {
        this.addAuth(opts);
    ...
    // put(url, data, opts={}) {
    //     this.addAuth(opts);
    //     return this.http.put(url, data, opts).pipe(map(this.mapData));
    // }
    ...
    getAnonymous(url, opts = {}) {
        return this.http.get(url, opts).pipe(map(this.mapData));
    }
