  ...
  imports: [RouterModule.forChild([
    {
      ...
      children: [
        { path: 'manage', component: ProfileManageComponent, data: { breadcrumb: 'Manage People' } },
        {

          path: '',
          children: [
            { path: ':id/:slug', component: ProfileDetailComponent },
    ...
    },
    {
      path: 'profiles',
      canActivate: [AuthGuardService ],
      component: ProfileBrowserComponent
    }
  ])],
