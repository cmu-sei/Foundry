...
export class SystemNotificationDialog extends BaseComponent {
  name: string = 'System Notification';
  description: string = '';

  constructor(
    public dialogRef: MatDialogRef<SystemNotificationDialog>,
