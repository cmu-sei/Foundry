...
namespace Stack.Validation.Tests
{
    public class TestContext : IDisposable
    {
        ...
        public IStackIdentityResolver IdentityResolver
        {
            get
            {
                return new ExplicitIdentityResolver(new StackIdentity { Id = "x" });
            }
        }
        ...
        public TestContext()
        {
            ...
            ValidationHandler = new StrictValidationHandler(DbContext, IdentityResolver);
        }
