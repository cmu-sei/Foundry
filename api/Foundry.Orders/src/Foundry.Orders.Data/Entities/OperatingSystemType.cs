...
{    
    public class OperatingSystemType
    {
        ...
        public ICollection<OrderOperatingSystemType> OrderOperatingSystemTypes { get; set; }
    }

    public class OrderOperatingSystemType : IJoinEntity
    {
        [Key]
        public int Id { get; set; }
        ...
        [ForeignKey("OperatingSystemTypeId")]
