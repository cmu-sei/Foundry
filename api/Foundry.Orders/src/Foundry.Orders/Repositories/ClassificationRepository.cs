...
{
    public class ClassificationRepository : Repository<OrdersDbContext, Classification>, IClassificationRepository
    {
        public ClassificationRepository(OrdersDbContext db)
            : base(db) { }
    }
}
