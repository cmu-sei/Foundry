...
{
    public class AssessmentTypeRepository : Repository<OrdersDbContext, AssessmentType>, IAssessmentTypeRepository
    {
        public AssessmentTypeRepository(OrdersDbContext db)
            : base(db) { }
    }
}
