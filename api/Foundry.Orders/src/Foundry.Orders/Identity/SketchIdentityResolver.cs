...
namespace Foundry.Orders.Identity
{
    ...
    public class SketchIdentityResolver : HttpIdentityResolver
    {
        ...
        public SketchIdentityResolver(IHttpContextAccessor httpContextAccessor, OrdersDbContext dbContext, IProfileCache accountCache, ILogger<SketchIdentityResolver> logger)
            : base(httpContextAccessor)
        {
            DbContext = dbContext ?? throw new ArgumentNullException(nameof(dbContext));
            ProfileCache = accountCache ?? throw new ArgumentNullException(nameof(accountCache));
        ...
        ISketchIdentityStrategy GetStrategy(ClaimsPrincipal claimsPrincipal)
        {
            ...
            return new ProfileIdentityStrategy(DbContext, ProfileCache, claimsPrincipal);
        }
    }
}
