...
{
    public class ContentEventCreate
    {
    ...
    public class ContentEventSummary : IAnalyticsEventSummary
    {
    ...
    public class ContentEventDataFilter : IDataFilter<ContentEvent>
    {
        ...
        public IQueryable<ContentEvent> FilterQuery(IQueryable<ContentEvent> query, IStackIdentity identity)
        {
        ...
        public IQueryable<ContentEvent> SearchQuery(IQueryable<ContentEvent> query)
        {
            ...
            return query.Where(c =>
                c.ContentId.ToLower().Contains(term) ||
                c.Type.ToLower().Contains(term)
            );
        }

        public IOrderedQueryable<ContentEvent> SortQuery(IQueryable<ContentEvent> query)
        {
