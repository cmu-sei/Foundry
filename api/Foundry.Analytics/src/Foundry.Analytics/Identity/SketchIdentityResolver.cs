...
namespace Foundry.Analytics.Identity
{
    ...
    {
        AnalyticsDbContext DbContext { get; }
        ...
        public SketchIdentityResolver(IHttpContextAccessor httpContextAccessor, AnalyticsDbContext dbContext, ILogger<SketchIdentityResolver> logger)
