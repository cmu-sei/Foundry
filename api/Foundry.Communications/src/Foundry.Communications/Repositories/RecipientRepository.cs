...
namespace Foundry.Communications.Repositories
{
    ...
    /// </summary>
    public class RecipientRepository : Repository<CommunicationDbContext, Recipient>, IRecipientRepository
    {
        /// <summary>
        /// create an instance of recipient repository
        /// </summary>
        /// <param name="db"></param>
        public RecipientRepository(CommunicationDbContext db)
            : base(db) { }
    }
}
