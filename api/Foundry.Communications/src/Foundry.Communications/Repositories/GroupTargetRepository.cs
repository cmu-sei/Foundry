...
namespace Foundry.Communications.Repositories
{
    ...
    /// </summary>
    public class GroupTargetRepository : Repository<CommunicationDbContext, GroupTarget>, IGroupTargetRepository
    {
        /// <summary>
        /// create an instance of group target repository
        /// </summary>
        /// <param name="db"></param>
        public GroupTargetRepository(CommunicationDbContext db)
            : base(db) { }
    }
}
