...
namespace Foundry.Communications.Repositories
{
    ...
    /// message repository
    /// </summary>
    public class MessageRepository : Repository<CommunicationDbContext, Message>, IMessageRepository
    {
        /// <summary>
        /// create an instance of message repository
        /// </summary>
        /// <param name="db"></param>
        public MessageRepository(CommunicationDbContext db)
            : base(db) { }
    }
}
