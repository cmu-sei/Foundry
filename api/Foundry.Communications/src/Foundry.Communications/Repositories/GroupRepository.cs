...
namespace Foundry.Communications.Repositories
{
    ...
    /// group repository
    /// </summary>
    public class GroupRepository : Repository<CommunicationDbContext, Group>, IGroupRepository
    {
        /// <summary>
        /// create an instance of group repository
        /// </summary>
        /// <param name="db"></param>
        public GroupRepository(CommunicationDbContext db)
            : base(db) { }
    }
}
