...
namespace Foundry.Communications.Identity
{
    public class ClientIdentityStrategy : ISketchIdentityStrategy
    {
        ...
        public CommunicationDbContext DbContext { get; }
        public string Subject { get; }
        public string Name { get; }
        public string ClientId { get; }

        public ClientIdentityStrategy(CommunicationDbContext db, ClaimsPrincipal claimsPrincipal)
        {
        ...
        {
            return new ClientIdentity() { Id = ClientId, Name = Name, Subject = Subject, ClientId = ClientId };
        }
