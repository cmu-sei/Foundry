...
{
    public class Profile : IEntityPrimary, IEntityGlobal, IEntityLogo, IRated
    {
        ...
        public ICollection<ProfileFollower> Following { get; set; } = new HashSet<ProfileFollower>();
        ...
        public ICollection<ProfileKeyValue> KeyValues { get; set; } = new HashSet<ProfileKeyValue>();
