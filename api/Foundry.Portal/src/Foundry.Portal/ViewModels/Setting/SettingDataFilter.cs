...
{
    public class SettingDataFilter : IDataFilter<Setting>
    {
        ...
        public IQueryable<Setting> FilterQuery(IQueryable<Setting> query, IStackIdentity profile)
        {
        ...
        public IQueryable<Setting> SearchQuery(IQueryable<Setting> query)
        {
        ...
        public IOrderedQueryable<Setting> SortQuery(IQueryable<Setting> query)
        {
