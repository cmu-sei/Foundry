...
{
    public class DiscussionDataFilter : IDataFilter<Discussion>
    {
        ...
        public IQueryable<Discussion> FilterQuery(IQueryable<Discussion> query, IStackIdentity profile)
        {
        ...
        public IQueryable<Discussion> SearchQuery(IQueryable<Discussion> query)
        {
        ...
        public IOrderedQueryable<Discussion> SortQuery(IQueryable<Discussion> query)
        {
