...
{
    public class PlaylistRateNotification : NotificationStrategy
    {
        public override DomainEventType DomainEventType => DomainEventType.PlaylistRate;
        ...
        public override async Task<NotificationCreate> Build()
        {
            ...
            {
                GlobalId = GlobalId,
                Subject = "Playlist Rated",
                Body = string.Format("A new rating for playlist '{0}'.", entity.Name),
                Values = ToValues(),
