...
{
    public class ContentRateNotification : NotificationStrategy
    {
        public override DomainEventType DomainEventType => DomainEventType.ContentRate;
        ...
        public override async Task<NotificationCreate> Build()
        {
            ...
            {
                GlobalId = GlobalId,
                Subject = "Content Rated",
                Body = string.Format("Content '{0}' was rated.", entity.Name),
                Values = ToValues(),
