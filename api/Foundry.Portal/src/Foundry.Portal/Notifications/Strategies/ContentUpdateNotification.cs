...
{
    public class ContentUpdateNotification : NotificationStrategy
    {
        public override DomainEventType DomainEventType => DomainEventType.ContentUpdate;
        ...
        public override async Task<NotificationCreate> Build()
        {
            ...
            var notification = new NotificationCreate
            {
                ...
                Body = string.Format("Content '{0}' was changed.", entity.Name),
                Values = ToValues(),
