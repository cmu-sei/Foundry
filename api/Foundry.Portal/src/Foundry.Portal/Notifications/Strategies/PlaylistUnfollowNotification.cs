...
{
    public class PlaylistUnfollowNotification : NotificationStrategy
    {
        public override DomainEventType DomainEventType => DomainEventType.PlaylistUnfollow;
        ...
        public override async Task<NotificationCreate> Build()
        {
            ...
            var notification = new NotificationCreate
            {
                ...
                Body = string.Format("Follower lost for playlist '{0}'.", entity.Name),
                Values = ToValues(),
