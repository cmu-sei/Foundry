...
{
    public class ContentDeleteNotification : NotificationStrategy
    {
        public override DomainEventType DomainEventType => DomainEventType.ContentDelete;
        ...
        public override async Task<NotificationCreate> Build()
        {
            var notification = new NotificationCreate
            {
                ...
                Body = string.Format("Content '{0}' was deleted.", DomainEvent.Name),
                Values = ToValues(),
