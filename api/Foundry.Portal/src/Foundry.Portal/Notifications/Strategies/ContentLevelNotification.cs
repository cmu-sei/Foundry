...
{
    public class ContentLevelNotification : NotificationStrategy
    {
        public override DomainEventType DomainEventType => DomainEventType.ContentLevel;
        ...
        public override async Task<NotificationCreate> Build()
        {
            ...
            var notification = new NotificationCreate
            {
                ...
                Body = string.Format("Content '{0}' difficulty was set.", entity.Name),
                Values = ToValues(),
