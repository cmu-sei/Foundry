...
{
    public class PlaylistAddNotification : NotificationStrategy
    {
        public override DomainEventType DomainEventType => DomainEventType.PlaylistAdd;
        ...
        public override async Task<NotificationCreate> Build()
        {
            ...
            {
                GlobalId = GlobalId,
                Subject = "Playlist Added",
                Body = string.Format("Playlist '{0}' was created.", entity.Name),
                Values = ToValues(),
