...
{
    public class PlaylistLogoUrlIsRequired : IValidationRule<PlaylistCreate>, IValidationRule<PlaylistUpdate>
    {
        ...
        void EnsureLogoUrlIsPresent(string logoUrl)
        {
            if (string.IsNullOrWhiteSpace(logoUrl))
                throw new InvalidModelException("Playlist logo url is required.");
        }
    }
}
