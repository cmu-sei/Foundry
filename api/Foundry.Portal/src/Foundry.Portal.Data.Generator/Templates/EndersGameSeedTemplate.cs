...
{
    public class EndersGameSeedTemplate : SeedTemplate
    {
        public EndersGameSeedTemplate(CoreOptions options, SketchDbContext dbContext, ILoggerFactory loggerFactory, IValidationHandler validationHandler, AutoMapper.IMapper mapper)
        ...
        public void Run()
        {
            ...
            // Graff Profile
            var graff = new ProfileSeedModel()
            {
                Name = "Graff",
            ...
            // Ender Profile
            var ender = new ProfileSeedModel()
            {
                Name = "Ender Wiggen",
            ...
            // Graff Profile
            var bonzo = new ProfileSeedModel()
            {
                Name = "Bonzo",
