        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DifficultyAverage = table.Column<double>(type: "float", nullable: false),
                    DifficultyMedian = table.Column<int>(type: "int", nullable: false),
                    DifficultyTotal = table.Column<int>(type: "int", nullable: false),
                    GlobalId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HoverUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    RatingMedian = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileContentId = table.Column<int>(type: "int", nullable: true),
                    ProfileId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AchievementId = table.Column<int>(type: "int", nullable: false),
                    ContentInstanceId = table.Column<int>(type: "int", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GlobalId = table.Column<string>(type: "nvarchar(max)", nullable: true),
