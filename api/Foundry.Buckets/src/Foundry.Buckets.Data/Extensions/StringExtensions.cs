...
namespace Foundry.Buckets.Data
{
    public static class StringExtensions
    {
        ...
        /// <summary>
        /// replace characters that are not url friendly and replace spaces with delimiter
        /// </summary>
        /// <param name="value"></param>
        /// <param name="truncate"></param>
        /// <param name="truncateAt"></param>
        /// <returns></returns>
        public static string ToSlug(this string value, bool truncate = true, int truncateAt = 100)
        {
        ...
        /// <summary>
        /// truncate string if over max length
        /// </summary>
        /// <param name="value"></param>
