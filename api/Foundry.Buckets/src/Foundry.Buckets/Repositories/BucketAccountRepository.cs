...
namespace Foundry.Buckets.Repositories
{
    ...
    /// bucket account repo
    /// </summary>
    public class BucketAccountRepository : Repository<BucketsDbContext, BucketAccount>, IBucketAccountRepository
    {
        /// <summary>
        /// create instance
        /// </summary>
        /// <param name="db"></param>
        public BucketAccountRepository(BucketsDbContext db)
            : base(db) { }
    }
}
