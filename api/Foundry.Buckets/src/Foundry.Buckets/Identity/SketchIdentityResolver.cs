...
namespace Foundry.Buckets.Identity
{
    ...
    public class SketchIdentityResolver : HttpIdentityResolver
    {
        ...
        IAccountCache AccountCache { get; }
        ...
        public SketchIdentityResolver(IHttpContextAccessor httpContextAccessor, BucketsDbContext dbContext, IAccountCache accountCache, ILogger<SketchIdentityResolver> logger)
        ...
        ISketchIdentityStrategy GetStrategy(ClaimsPrincipal claimsPrincipal)
        {
            ...
            return new ProfileIdentityStrategy(DbContext, AccountCache, claimsPrincipal);
        }
    }
}
