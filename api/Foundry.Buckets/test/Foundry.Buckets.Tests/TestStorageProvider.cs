...
namespace Foundry.Buckets.Tests
{
    ...
    {
        public async Task<FileStorageResult> Delete(FileDetail file)
        {
            return new FileStorageResult() { Type = FileStorageResultType.DeleteComplete };
        }
        ...
        public async Task<FileStorageResult> Save(IFormFile formFile, BucketDetail bucket)
        {
            ...
            {
                Type = FileStorageResultType.UploadComplete,
