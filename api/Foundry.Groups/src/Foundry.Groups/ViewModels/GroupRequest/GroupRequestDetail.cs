...
{
    public class GroupRequestDetail
    {
        public string ParentGroupId { get; set; }

        public string ParentGroupName { get; set; }

        public string ParentGroupSlug { get; set; }

        public string ChildGroupId { get; set; }

        public string ChildGroupName { get; set; }

        public string ChildGroupSlug { get; set; }
        ...
        public GroupRequestActions Actions { get; set; } = new GroupRequestActions();
    }
}
