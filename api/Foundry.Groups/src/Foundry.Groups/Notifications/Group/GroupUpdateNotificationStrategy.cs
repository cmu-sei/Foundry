...
{
    public class GroupUpdateNotificationStrategy : NotificationCreateStrategy
    {
        public GroupUpdateNotificationStrategy(CommunicationOptions communicationOptions, IDomainEvent domainEvent)
            : base(communicationOptions, domainEvent) { }

        public override string Label => "update";

        public override string Type => "groupupdate";
        ...
        public async override Task<NotificationCreate> GetModel()
        {
            ...
            var notification = new NotificationCreate
            {
                ...
                Body = string.Format("Group '{0}' was changed.", DomainEvent.Name),
                Values = ToNotificationCreateValues(),
                Url = ToLocalUrl("group", group.Id, group.Slug),
                Recipients = owners.ToArray()
            };
